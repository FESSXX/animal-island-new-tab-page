...
WXT starts an extension development server and builds the extension for local browser testing.
...
Weather uses browser geolocation and Open-Meteo:

- Permission: `geolocation`
- Host permission: `https://api.open-meteo.com/*`
- If location access or the API request fails, the page falls back to Beijing demo weather.
...
This project is currently focused on the new-tab page. Popup, options page, background scripts, and content scripts can be added later as separate WXT entrypoints.
